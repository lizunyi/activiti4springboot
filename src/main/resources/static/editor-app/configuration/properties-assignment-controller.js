...
var KisBpmAssignmentPopupCtrl = [ '$scope', function($scope) {
    ...
    $scope.mutil_userselect = function(index,o){
    	...
    	$scope.assignment.candidateUsers[index].show = false;
    };
    $scope.mutil_groupselect = function(index,o){
    	$scope.assignment.candidateGroups[index].value = "ROLE(" + o.rolename + ")";
    	$scope.assignment.candidateGroups[index].show = false;
    };
    $scope.usermutil = function(item){
    	item.show = true;
    };
